...
public class Compressor {
    ...
    public static void compress(String filePath) {
        String path = filePath.substring(0,filePath.lastIndexOf(".")) + ".hf";
        String dictPath = filePath.substring(0,filePath.lastIndexOf(".")) + ".table";
        Compressor compressor = new Compressor(FileReader.readFile(filePath));
        CompressionResult compressionResult = compressor.compress();
        FileWriter.writeCompressedFile(compressionResult.getLength(), compressionResult.getBytes(compressionResult.getBytesInt()), compressor.getDictionary(), path, dictPath);
    }
}
