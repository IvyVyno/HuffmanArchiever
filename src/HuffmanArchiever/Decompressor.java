...
public class Decompressor {
    ...
    public static void decompress(String filePath) {
        String dictLocation = filePath.substring(0,filePath.lastIndexOf(".")) + ".table";
        byte[] bytes = FileReader.readFile(filePath);
        Dictionary dictionary = FileReader.readDictionary(dictLocation);
        ...
        String decFileLocation = filePath.substring(0,filePath.lastIndexOf(".")) + "Decompressed.txt";
        FileWriter.writeDecompressedFile(decompressor.decompress(), decFileLocation);
    }
}
